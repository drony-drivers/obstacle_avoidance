...
## OPTIMISATION: We can remove options that aren't required 
## here, to reduce computational complexity
# ARUCO_DICT = {
...
for img in images:
    ...
    for (arucoName, arucoDict) in ARUCO_DICT.items():
        ...
        if len(corners) > 0:
            print("Marker ID: {}, Landed".format(ids))
        else:
            print("Marker ID: none, looking for markers")
